...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Part.part_is_container'
        db.add_column('stock_part', 'part_is_container',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Part.part_container'
        db.add_column('stock_part', 'part_container',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='contained', null=True, to=orm['stock.Part']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Part.part_is_container'
        db.delete_column('stock_part', 'part_is_container')

        # Deleting field 'Part.part_container'
        db.delete_column('stock_part', 'part_container_id')
    ...
    models = {
        ...
        'stock.part': {
            ...
            'part_container': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'contained'", 'null': 'True', 'to': "orm['stock.Part']"}),
            'part_for_sale': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'part_is_container': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
